...
<html lang="de">
    <head>
        ...
        <title>Secure in Baukästen | by Marvin Roßkothen</title>
        ...
        <main class="slide">
            <div class="heading">
                <div class='heading-content'>
                    <h1>Secure in Baukasten einbinden</h1>
                    <p class="short">
                        Hier erfährst du, wie du DSA Secure in ein Baukasten-System einbinden kannst.
                    </p>
                </div>
            </div>
            ...
            <div class="content">
                ...
                <div>
                    ...
                    <p>Maps Bild: <code class='inline'>https://dsa-secure.de/cdn/maps.jpg</code></p>
                </div>
            </div>
        </main>
    </body>
